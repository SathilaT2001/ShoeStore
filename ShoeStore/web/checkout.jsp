<%-- 
    Document   : pheckout
    Created on : May 9, 2024, 10:25:21 PM
...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #PayButton:hover {
                background-color: #32c75f!important;
            }
                ...
                <form action="CheckoutServlet" method="post">
                    <div class="form-group">
                        ...
                        <div class="amount-placeholder">
                            <span>$</span>
                            <span><%= String.format("%.2f",all_total)%></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <button id="PayButton" class="btn btn-block btn-success submit-button" type="submit">
                        ...
                        <span class="align-middle" id="paymentAmount">Pay $<%= String.format("%.2f",all_total)%></span>
                    </button>
                </form>
            </div>
        </div>
